...
typedef NS_ENUM(NSInteger, JTCalendarWeekDayFormat) {
    ...
    JTCalendarWeekDayFormatChShort,
};
...
@property (strong, nonatomic) UIColor *menuMonthBgColor;
...
@property (strong, nonatomic) UIColor *weekDayBgColor;
...
@property (strong, nonatomic) UIColor *dayTextColorForTodaySelected;
