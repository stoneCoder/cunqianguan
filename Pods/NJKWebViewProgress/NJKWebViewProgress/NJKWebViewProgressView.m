...
-(void)configureViews
{
    ...
    UIColor *tintColor = [UIColor colorWithRed:41.f / 255.f green:174.f / 255.f blue:164.f / 255.f alpha:1.0];
    //[UIColor colorWithRed:22.f / 255.f green:126.f / 255.f blue:251.f / 255.f alpha:1.0]; // iOS7 Safari bar color
